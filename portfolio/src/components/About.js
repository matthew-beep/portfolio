...
export default function About(props) {
    ...
    return (      
        <div id='about' className='text-white about flex flex-col items-center'>
            ...
            <p className='regular w-1/2 text-justify text-2xl mb-3'>
            ...
            <p className='regular w-1/2 text-justify mb-3 text-2xl'>
            ...
            <p className='regular w-1/2 text-justify text-2xl'>
