        ...
        <div className='container home'>
            <div className='row align-items-center home-content'>
                <div className='col-12 col-md-6 intro-text'>
                    <h4 className='text-2xl'>Hi, I am</h4>
                    ...
                    <div className='inline-flex flex-col items-start'>
                        ...
                        <div className='flex justify-between w-3/4 mt-2'>
                                <a href='https://www.linkedin.com/in/matthewherradura/' target='_blank'><i class="fa-brands fa-linkedin text-5xl hover:text-white"></i></a>
